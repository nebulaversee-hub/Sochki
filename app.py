...
# ---------------------------------------------------------------------------
# Критерии ЕГЭ 2026 по русскому языку (задание 27), источник: ФИПИ / 4ege.ru
# К1–К10, максимум 22 балла
# ---------------------------------------------------------------------------
CRITERIA = {
    "K1":  "Отражение позиции автора (рассказчика) по указанной проблеме",
    "K2":  "Комментарий к позиции автора (рассказчика) по указанной проблеме",
    "K3":  "Собственное отношение к позиции автора и его обоснование",
    "K4":  "Фактическая точность речи",
    "K5":  "Логичность речи",
    "K6":  "Соблюдение этических норм",
    "K7":  "Соблюдение орфографических норм",
    "K8":  "Соблюдение пунктуационных норм",
    "K9":  "Соблюдение грамматических норм",
...
# Подсказки с критериями выставления баллов для каждого критерия
SCORE_HELP = {
    "K1":  "1 — позиция сформулирована верно; 0 — не сформулирована или неверно",
    "K2":  "3 — 2 примера + пояснение к каждому + смысловая связь с пояснением; "
           "2 — 2 примера + пояснение, но смысловая связь без пояснения; "
           "1 — 1 пример с пояснением; 0 — иначе",
    "K3":  "2 — отношение обосновано + пример-аргумент; "
           "1 — обосновано без примера ИЛИ есть пример, но отношение заявлено формально; "
           "0 — только «согласен/не согласен» или ничего",
    "K4":  "1 — фактических ошибок нет; 0 — есть хотя бы одна",
    "K5":  "2 — логических ошибок нет; 1 — 1–2 ошибки; 0 — 3 и более",
    "K6":  "1 — этических нарушений нет; 0 — есть",
    "K7":  "3 — ошибок нет; 2 — 1–2 ошибки; 1 — 3–4 ошибки; 0 — 5 и более",
    "K8":  "3 — ошибок нет; 2 — 1–2 ошибки; 1 — 3–4 ошибки; 0 — 5 и более",
    "K9":  "3 — ошибок нет; 2 — 1–2 ошибки; 1 — 3–4 ошибки; 0 — 5 и более",
    "K10": "3 — ошибок нет; 2 — 1–2 ошибки; 1 — 3–4 ошибки; 0 — 5 и более",
}
...
# ---------------------------------------------------------------------------
PROMPT_TEMPLATE = """Ты — эксперт ЕГЭ по русскому языку. Проверь сочинение-рассуждение (задание 27) строго по критериям ФИПИ 2026.

КРИТЕРИИ ОЦЕНИВАНИЯ (К1–К10, максимум 22 балла):
К1 (макс 1): Отражение позиции автора по проблеме. 1 — верно; 0 — неверно/не сформулировано. Если К1=0, то К2=К3=0.
К2 (макс 3): Комментарий к позиции автора. 3 — 2 примера+пояснение к каждому+смысловая связь с пояснением; 2 — 2 примера+пояснение, но связь без пояснения; 1 — 1 пример с пояснением; 0 — иначе.
К3 (макс 2): Отношение к позиции автора. 2 — обосновано+пример-аргумент; 1 — обосновано без примера ИЛИ пример есть но отношение формальное («согласен/не согласен»); 0 — только формальное заявление или ничего.
К4 (макс 1): Фактическая точность. 1 — ошибок нет; 0 — есть хотя бы одна.
К5 (макс 2): Логичность. 2 — ошибок нет; 1 — 1–2 ошибки; 0 — 3 и более.
К6 (макс 1): Этические нормы. 1 — нарушений нет; 0 — есть.
К7 (макс 3): Орфография. 3 — ошибок нет; 2 — 1–2; 1 — 3–4; 0 — 5 и более.
К8 (макс 3): Пунктуация. 3 — ошибок нет; 2 — 1–2; 1 — 3–4; 0 — 5 и более.
К9 (макс 3): Грамматика. 3 — ошибок нет; 2 — 1–2; 1 — 3–4; 0 — 5 и более.
К10 (макс 3): Речевые нормы. 3 — ошибок нет; 2 — 1–2; 1 — 3–4; 0 — 5 и более.
...
Верни ТОЛЬКО JSON-объект (никакого другого текста, без ```, без пояснений):
{{"corrected_text":"полный текст сочинения, орфографические/пунктуационные/грамматические/речевые ошибки выделены **жирным**","scores":{{"K1":0,"K2":0,"K3":0,"K4":0,"K5":0,"K6":0,"K7":0,"K8":0,"K9":0,"K10":0}},"comments":{{"K1":"","K2":"","K3":"","K4":"","K5":"","K6":"","K7":"","K8":"","K9":"","K10":""}}}}
"""
...
if result:
    ...
    st.divider()
    st.subheader("Баллы по критериям (К1–К10)")
    st.caption(
        "Баллы предложены ИИ на основе критериев ФИПИ 2026 — вы можете изменить любое значение. "
        "Наведите курсор на знак ❓ рядом с критерием, чтобы увидеть шкалу оценивания."
    )
